...
var text=Array("Rainbow Dash is da best Pony !", "    what's up , Brony ?", "This Site needs to be 20% cooler"); // replace this with an array of your own text
var delay=8; // seconds between each new text item
